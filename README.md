...
The Slackbot sends events to the `acronymBotLambda` function. Slack sends a challenge to bots attempting to join a workspace, so the bot checks to see if the incoming message is a challenge, and responds with a 200.
